...
public class UserRepositoryImpl extends AbstractDatabaseService implements UserRepository {
    ...
    private static final String INIT_TABLE_QUERY = "CREATE TABLE IF NOT EXISTS eternal_economy_users (uniqueId UUID PRIMARY KEY, name VARCHAR(255), balance NUMERIC(19,2));";
    private static final String SAVE_USER_QUERY = "INSERT INTO eternal_economy_users (uniqueId, name, balance) VALUES (?, ?, ?);";

...
public class EconomyPermissionConstant {

    public static final String ADMIN_BALANCE_PERMISSION = "eternaleconomy.admin.balance";
    public static final String ADMIN_RESET_PERMISSION = "eternaleconomy.admin.reset";
    public static final String ADMIN_ADD_PERMISSION = "eternaleconomy.admin.add";
    ...
    public static final String PLAYER_TOP_BALANCE_PERMISSION = "eternaleconomy.player.balance.top";
}

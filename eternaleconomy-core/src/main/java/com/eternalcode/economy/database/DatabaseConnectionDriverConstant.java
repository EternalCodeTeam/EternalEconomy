...
class DatabaseConnectionDriverConstant {
    ...
    static final String MYSQL_JDBC_URL = "jdbc:mysql://%s:%s/%s";

    // maria db
    static final String MARIADB_DRIVER = "org.mariadb.jdbc.Driver";
    static final String MARIADB_JDBC_URL = "jdbc:mariadb://%s:%s/%s";
    ...
    static final String POSTGRESQL_JDBC_URL = "jdbc:postgresql://%s:%s/";
}

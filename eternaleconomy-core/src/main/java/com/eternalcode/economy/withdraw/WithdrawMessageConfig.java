...
public class WithdrawMessageConfig extends OkaeriConfig {
    ...
    public Notice withdrawCooldown = Notice.chat(
        "<b><gradient:#00FFA2:#34AE00>ECONOMY</gradient></b> <dark_gray>➤</dark_gray> <red>You must wait <white>{TIME}</white> seconds before withdrawing again!");
}

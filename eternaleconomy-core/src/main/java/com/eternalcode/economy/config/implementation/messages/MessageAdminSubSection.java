...
public class MessageAdminSubSection extends OkaeriConfig {
    ...
    public Notice insufficientFunds =
        Notice.chat( "{PREFIX}<white>Player {PLAYER} has insufficient funds,"
            + "they are missing <gradient:#00FFA2:#34AE00>{MISSING_BALANCE}</gradient>.</white>");


    public Notice added =
        Notice.chat( "{PREFIX}<white>Added <gradient:#00FFA2:#34AE00>{AMOUNT}</gradient> to "
            + "<gradient:#00FFA2:#34AE00>{PLAYER}</gradient>.</white>");
    public Notice removed =
        Notice.chat("{PREFIX}<white>Removed <gradient:#00FFA2:#34AE00>{AMOUNT}</gradient> from "
            + "<gradient:#00FFA2:#34AE00>{PLAYER}</gradient>.</white>");
    public Notice set =
        Notice.chat( "{PREFIX}<white>Set <gradient:#00FFA2:#34AE00>{PLAYER}</gradient>'s balance to "
            + "<gradient:#00FFA2:#34AE00>{AMOUNT}</gradient>.</white>");
    public Notice reset =
        Notice.chat("{PREFIX}<white>Reset <gradient:#00FFA2:#34AE00>{PLAYER}</gradient>'s balance.</white>");
    public Notice balance =
        Notice.chat("{PREFIX}<white><gradient:#00FFA2:#34AE00>{PLAYER}</gradient>'s balance is "

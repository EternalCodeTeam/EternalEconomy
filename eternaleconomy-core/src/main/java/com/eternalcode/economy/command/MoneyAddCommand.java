...
public class MoneyAddCommand {
    ...
    public MoneyAddCommand(AccountPaymentService accountPaymentService, NoticeService noticeService, DecimalFormatter decimalFormatter) {
    ...
    void execute(@Context CommandSender commandSender, @Arg Account receiver, @Arg BigDecimal amount) {
        ...
        this.noticeService.create()
                .notice(messageConfig -> messageConfig.addBalance)
